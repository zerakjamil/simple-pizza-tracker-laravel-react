...
const PizzaStats = ({ currentStatus  }) => {
    ...
    const getClass = (status, index)=>{
        ...
        if(status === currentStatus){
            ...
            return `${baseClasses} from-red-500 to-red-600 scale-110 rounded`;
        }
  ...
  return (
    <div className={"flex border-4 border-blue-200 rounded-full"}>
        {statuses.map((status, index) => <div key={index} className={getClass(status,index)}>
